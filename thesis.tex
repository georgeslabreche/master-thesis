...
Design of SherpaTT Rover Solar Arrays for Simulated Mars Mission Phases and Analysis of Operational Scenarios%
}
...
%\acresetall                 %% reset all acronym abbreviations and write first appearance long
%\input{sections/acused.tex} %%define ackronyms that are "common sense"
\input{sections/martian-environment/index.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Generated Power and Energy}
%\shinyChapterQuote{I have the power!}
%  {He-Man}
\label{sec:PowerAndEnergyPredictions}
\input{sections/power-and-energy-predictions/index.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Mission Sites}
\label{sec:MissionSites}
\input{sections/mission-sites/index.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Reference Sols}
\label{sec:ReferenceSols}
\input{sections/reference-sols/index.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
