...
\usepackage[bookmarks,bookmarksopen=false,bookmarksnumbered=true,pdftex,pdfhighlight=/N,
  ...
  colorlinks=true,
  pdftitle={Exploiting the SherpaTT Rover Active Suspension System to Enable Optimal Solar Array Inclination and Orientation for Long Traverses in a Martian Environment},
  pdfsubject={},  % insert subtitle
  pdfkeywords={Mars, Rover, Active Suspension System, Solar Array, Power, Energy},
...
\newcites{marsenv,power,other,datasheet}%
         {Mars Environment References,Power References,Other References,Datasheets}%
\bibliographystylemarsenv{ieeetr}%{alpha}
\bibliographystylepower{ieeetr}%{alpha}
\bibliographystyleother{ieeetr}%{alpha}
\bibliographystyledatasheet{ieeetr}%{alpha}
