...
\input{sections/power-system-design/reference-sols/tables/rover-modes.tex}
...
\input{sections/power-system-design/reference-sols/tables/mission-scenario-traverse-sol.tex}
...
The \textit{Hibernation Sol} shown in \refTab{tab:mission-scenario-hibernation-sol} ensures the rover's survival  during a dust storm. In this setting, the rover solely draws power from its battery. Only the heaters and a timer are active so that energy may be conserved.

\input{sections/power-system-design/reference-sols/tables/mission-scenario-hibernation-sol.tex}
