...
\input{sections/power-system-design/reference-sols/index.tex}

\clearpage
\section{Power Budget}
\label{sec:Design:PowerBudget}
\input{sections/power-system-design/power-budget/index.tex}

\clearpage
\section{Requirements and Design Drivers}
\label{sec:Design:RequirementsAndDesignDrivers}
\input{sections/power-system-design/requirements-and-design-drivers/index.tex}

\clearpage
\section{Solar Array}
\label{sec:Design:SolarArray}
\input{sections/power-system-design/solar-array/index.tex}

\clearpage
\section{Simulation}
\label{sec:Design:Simulation}
\input{sections/power-system-design/simulation/index.tex}
