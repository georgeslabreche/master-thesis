...
\vspace{-2ex}
    ...
    \caption[Generated energy and maxium flat terrain traverse durations at Ismenius Cavus]
            {Generated energy and maxium flat terrain traverse duration at Ismenius Cavus with solar cell coverage area of \SI{4.1}{m^{2}}. The same considerations were taken as in \refFig{fig:plot:iani-chaos-generated-energy-and-max-traverse-durations}.}
...
\vspace{-2ex}
    ...
    \caption[Maximum traverse durations at mission sites]
            {Maximum traverse durations at mission sites. The same considerations were taken as in \refFig{fig:plot:iani-chaos-generated-energy-and-max-traverse-durations}.}
