...
\newcites{sota,own,marsenv,moonenv,power}%
         {Literature References,Own Publications,Mars Environment Literature,Moon Environment Literature,Power Literature}%
\bibliographystylesota{apalike}%{alpha}
\bibliographystyleown{ieeetr}%{unsrt}%{plain}
\bibliographystylemarsenv{apalike}%{alpha}
\bibliographystylemoonenv{apalike}%{alpha}
\bibliographystylepower{apalike}%{alpha}
