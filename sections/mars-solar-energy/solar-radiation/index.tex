...
\input{sections/mars-solar-energy/solar-radiation/tables/mars-seasons.tex}
...
Solar radiation calculations using \refEqn{eq:G_obh} as a function of Solar time are presented in \refFig{fig:plot:diurnal-variation-of-beam-irradiance-on-a-horizontal-surface-at-top-of-mars-atmosphere}.
...
The expression for $G_{h}$ and $G_{bh}$ are presented in \refEqn{eq:G_h} and \refEqn{eq:G_bh}:
