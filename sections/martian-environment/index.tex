...
\begin{itemize}
    \item Taking advantage of the active suspension system to tilt the solar array into an optimal inclination angle while the rover is on a horizontal surface.
    \item Taking advantage of the active suspension system to tilt the solar array into a horizontal configuration while the rover is on an inclined surface.
    \item Traversing descent and ascent profiles such as with the topographic slope variation in crater exploration missions.
\end{itemize}

The above scenarios are further elaborated in Section \ref{sec:ReferenceSols:RoverModes} where rover modes are defined.
