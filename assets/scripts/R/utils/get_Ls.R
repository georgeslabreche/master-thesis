...
#' Get Areocentric Longitude given a terrestrial date.
#' 
...
#'
#' @param date terrestial date. e.g. 9-Apr-1984.
#' @param format date pattern. e.g. %d-%b-%Y.
#' @param force_bounding force value to be beween 0 and 360 degrees.
#'
#' @return
#' @export
#'
#' @examples
get_Ls = function(date, format, force_bounding=FALSE){
